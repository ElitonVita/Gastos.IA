  ...
  "pt": {
    ...
    "settings": {
      ...
      "data": {
        ...
        "server": "Salvando no servidor (compartilhado)",
        "serverSub": "gastos-data.json fica na pasta do servidor — computador e celular usam o mesmo arquivo, sem precisar escolher pasta em cada aparelho.",
        ...
        "restoredFromServer": "Restaurado do servidor ({count} transações, {date})",
        "syncedFromServer": "🔄 Dados atualizados a partir do servidor ({date}) — outra aba ou aparelho salvou algo novo.",
      ...
      "ai": {
        ...
        "footerNote": "100% offline · <span class=\"text-zinc-400\">gemma4:latest</span> já detectado (9.6 GB) · Nada sai da sua rede.",
  ...
  "en": {
    ...
    "settings": {
      ...
      "data": {
        ...
        "server": "Saving to server (shared)",
        "serverSub": "gastos-data.json lives in the server's folder — computer and phone use the same file, no need to choose a folder on each device.",
        ...
        "restoredFromServer": "Restored from server ({count} transactions, {date})",
        "syncedFromServer": "🔄 Data updated from the server ({date}) — another tab or device just saved something new.",
      ...
      "ai": {
        ...
        "footerNote": "100% offline · <span class=\"text-zinc-400\">gemma4:latest</span> already detected (9.6 GB) · Nothing leaves your network.",
